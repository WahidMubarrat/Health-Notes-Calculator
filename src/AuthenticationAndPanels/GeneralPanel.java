...
public class GeneralPanel {
    ...
    private void calculateFoodCalories() {
        ...
        FoodCaloryCalculator foodCaloryCalculator = new FoodCaloryCalculator("food_items.txt");
...
public class GeneralPanel {
    ...
    private void addNewFoodItem() {
        ...
        System.out.print("Enter the calorie value per 100 grams: ");
        double newCalories = scanner.nextDouble();

        FoodCaloryCalculator foodCaloryCalculator = new FoodCaloryCalculator("food_items.txt");
        foodCaloryCalculator.addFoodItem(newFoodItem, newCalories);
        pause();
    }
